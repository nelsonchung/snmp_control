...
#enable 1M, 2M, 5.5M, mcs0, 1, 2
snmpset $SNMP_PRIV $SNMP_IP 1.3.6.1.4.1.35604.1.19.51.1.5.4.1.14.1.21.32 x "E1C00000" 
snmpset $SNMP_PRIV $SNMP_IP 1.3.6.1.4.1.35604.1.19.51.1.5.4.1.14.1.21.33 x "E1C00000" 


#cmdot11ChannelSetting
snmpset $SNMP_PRIV $SNMP_IP 1.3.6.1.4.1.35604.1.19.51.1.5.1.3.0 u 4 
...
#enable 6M, 12M, 24M, mcs0, 1, 2 
snmpset $SNMP_PRIV $SNMP_IP 1.3.6.1.4.1.35604.1.19.51.3.1.2.1.1.1.21.40 x "FC000000" 
snmpset $SNMP_PRIV $SNMP_IP 1.3.6.1.4.1.35604.1.19.51.3.1.2.1.1.1.21.41 x "FC000000" 
