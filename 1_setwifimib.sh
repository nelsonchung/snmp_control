...
snmpset $SNMP_PRIV $SNMP_IP 1.3.6.1.4.1.35604.1.19.51.1.5.4.1.14.1.2.34 i 1
...
snmpset $SNMP_PRIV $SNMP_IP 1.3.6.1.4.1.35604.1.19.51.1.5.4.1.14.1.3.34 s "00Nelson_24G_G3"
...
snmpset $SNMP_PRIV $SNMP_IP 1.3.6.1.4.1.35604.1.19.51.1.5.4.1.14.1.10.34 i 1
#5G
...
snmpset $SNMP_PRIV $SNMP_IP 1.3.6.1.4.1.35604.1.19.51.3.1.2.1.1.1.2.42 i 1
...
snmpset $SNMP_PRIV $SNMP_IP 1.3.6.1.4.1.35604.1.19.51.3.1.2.1.1.1.3.42 s "00Nelson_5G_G3"
...
snmpset $SNMP_PRIV $SNMP_IP 1.3.6.1.4.1.35604.1.19.51.3.1.2.1.1.1.10.42 i 1
