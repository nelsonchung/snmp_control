...
count=`expr $count + 1`
echo "${count}. CH6643-3.5.1.12b-SH-TW.NNEMN.p7"
count=`expr $count + 1`
...
count=`expr $count + 1`
echo "${count}. CH6643-3.7.0.1u-SH-TW.NNEMN.p7"
count=`expr $count + 1`
echo "${count}. CH6643-3.7.0.2-SH-TW.NNEMN.p7"
count=`expr $count + 1`
echo "${count}. CH6643-3.7.0.2f-SH-TW.NNEMN.p7"
count=`expr $count + 1`
#count=`expr $count + 1`
#count=`expr $count + 1`
#echo "${count}. "
...
case $option in 
    ...
    ;;
    "2")
    FW_VER="CH6643-3.5.1.12b-SH-TW.NNEMN.p7"
    ;;
    "3")
    ...
    ;;
    "10")
    FW_VER="CH6643-3.7.0.1u-SH-TW.NNEMN.p7"
    ;;
    "11")
    FW_VER="CH6643-3.7.0.2-SH-TW.NNEMN.p7"
    ;;
    "12")
    FW_VER="CH6643-3.7.0.2f-SH-TW.NNEMN.p7"
    ;;
    *)
        echo  "Wrong value"
        exit
